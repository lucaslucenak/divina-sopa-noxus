...
insert into distance_tax(tax, initial_distance, final_distance, status_id) values (7.0, 2.0, 5.0, 1);
insert into deliveryman(name, cellphone_number, status_id) values ('Lucas', '83986907270', 1);
...
insert into delivery (address_id, deliveryman_id, delivery_type_id, distance_tax_id, status_id, tax, distance) values (1, 1, 1, 1, 1, 5.0, 2.3);
