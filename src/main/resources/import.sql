...
insert into product (name, description, price, image_url, size_id, status_id, product_type_id, created_at, updated_at) values ('MUNGUZA DOCE', 'Delicioso munguzá doce, cremoso e com opcional de canela.', 8.00, 'https://zaun-test.s3.amazonaws.com/munguzaDoce.jpeg', 1, 1, 1, NOW(), NOW());
...
insert into product (name, description, price, image_url, size_id, status_id, product_type_id, created_at, updated_at) values ('FEIJÃO', 'Deliciosa sopa de feijão (feijão carioca, macarrão, legumes selecionados da casa), acompanhada de torrada.', 8.00, 'https://zaun-test.s3.amazonaws.com/sopaFeijao.jpeg', 1, 1, 2, NOW(), NOW());
insert into product (name, description, price, image_url, size_id, status_id, product_type_id, created_at, updated_at) values ('PEIXE', 'Filé de merluza importado, cebola, alho triturado, cebolinha, coentro, creme de leite, legumes selecionados e especiarias da casa. Acompanha torradas.', 9.00, 'https://zaun-test.s3.amazonaws.com/sopaPeixe.jpeg', 1, 1, 2, NOW(), NOW());
insert into product (name, description, price, image_url, size_id, status_id, product_type_id, created_at, updated_at) values ('Suco De Laranja 500ml', 'Suco da Fruta.', 6.00, 'https://zaun-test.s3.amazonaws.com/sucoLaranja.jpeg', 1, 1, 3, NOW(), NOW());
insert into product (name, description, price, image_url, size_id, status_id, product_type_id, created_at, updated_at) values ('Suco1 De Laranja 500ml', 'Suco da Fruta.', 6.00, 'https://zaun-test.s3.amazonaws.com/sucoLaranja.jpeg', 1, 1, 3, NOW(), NOW());
...
insert into product (name, description, price, image_url, size_id, status_id, product_type_id, created_at, updated_at) values ('Açaí 2litro', '1litro do melhor e mais puro açaí. Se desejar pode pedir complementos a parte.', 22.00, 'https://zaun-test.s3.amazonaws.com/acaiUm.jpeg', 1, 1, 4, NOW(), NOW());
insert into product (name, description, price, image_url, size_id, status_id, product_type_id, created_at, updated_at) values ('Açaí 3litro', '1litro do melhor e mais puro açaí. Se desejar pode pedir complementos a parte.', 22.00, 'https://zaun-test.s3.amazonaws.com/acaiUm.jpeg', 1, 1, 4, NOW(), NOW());
insert into product (name, description, price, image_url, size_id, status_id, product_type_id, created_at, updated_at) values ('Açaí 4litro', '1litro do melhor e mais puro açaí. Se desejar pode pedir complementos a parte.', 22.00, 'https://zaun-test.s3.amazonaws.com/acaiUm.jpeg', 1, 1, 4, NOW(), NOW());
