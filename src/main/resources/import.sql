...
insert into address(street_name, street_number, city, cep, complement, reference_point, neighbourhood_id, client_account_id, created_at, updated_at) values ('Rua dos bobos', '0', 'Campina Grande', 'CEP', 'não tem nada', 'unica rua do bairro', 1, 1, NOW(), NOW());
