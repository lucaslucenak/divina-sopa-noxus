...
import com.lucalucenak.Noxus.exceptions.DeliveryAlreadyUsedAtAnotherOrderException;
...
@ControllerAdvice
public class DeliveryAlreadyUsedAtAnotherOrderExceptionHandler {

    @ResponseStatus(HttpStatus.BAD_REQUEST)
    @ResponseBody
    @ExceptionHandler(DeliveryAlreadyUsedAtAnotherOrderException.class)
    public ResponseEntity<ExceptionHandlerDto<String>> handle(DeliveryAlreadyUsedAtAnotherOrderException ex) {
