...
import com.lucalucenak.Noxus.exceptions.OrderValueLowerThanCouponMinimumValueException;
...
@ControllerAdvice
public class OrderValueLowerThanCouponMinimumValueExceptionHandler {

    @ResponseStatus(HttpStatus.BAD_REQUEST)
    @ResponseBody
    @ExceptionHandler(OrderValueLowerThanCouponMinimumValueException.class)
    public ResponseEntity<ExceptionHandlerDto<?>> handle(OrderValueLowerThanCouponMinimumValueException ex) {
