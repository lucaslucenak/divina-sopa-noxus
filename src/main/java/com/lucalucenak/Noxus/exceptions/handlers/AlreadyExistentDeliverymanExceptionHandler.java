...
@ControllerAdvice
public class AlreadyExistentDeliverymanExceptionHandler {

    @ResponseStatus(HttpStatus.BAD_REQUEST)
    @ResponseBody
    @ExceptionHandler(AlreadyExistentDeliverymanException.class)
    public ResponseEntity<ExceptionHandlerDto<String>> handle(AlreadyExistentDeliverymanException ex) {
