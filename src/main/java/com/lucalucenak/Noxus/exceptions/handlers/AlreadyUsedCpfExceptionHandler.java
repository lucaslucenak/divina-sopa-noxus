...
@ControllerAdvice
public class AlreadyUsedCpfExceptionHandler {

    @ResponseStatus(HttpStatus.BAD_REQUEST)
    @ResponseBody
    @ExceptionHandler(AlreadyUsedCpfException.class)
    public ResponseEntity<ExceptionHandlerDto<String>> handle(AlreadyUsedCpfException ex) {
