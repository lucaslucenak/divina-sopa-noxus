...
@ControllerAdvice
public class AlreadyDefinedDistanceTaxMetricExceptionHandler {

    @ResponseStatus(HttpStatus.BAD_REQUEST)
    @ResponseBody
    @ExceptionHandler(AlreadyDefinedDistanceTaxMetricException.class)
    public ResponseEntity<ExceptionHandlerDto<String>> handle(AlreadyDefinedDistanceTaxMetricException ex) {
