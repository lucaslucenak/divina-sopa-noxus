...
import com.lucalucenak.Noxus.exceptions.PaidValueLessThanOrderPriceException;
...
@ControllerAdvice
public class PaidValueLessThanOrderPriceExceptionHandler {

    @ResponseStatus(HttpStatus.BAD_REQUEST)
    @ResponseBody
    @ExceptionHandler(PaidValueLessThanOrderPriceException.class)
    public ResponseEntity<ExceptionHandlerDto<?>> handle(PaidValueLessThanOrderPriceException ex) {
