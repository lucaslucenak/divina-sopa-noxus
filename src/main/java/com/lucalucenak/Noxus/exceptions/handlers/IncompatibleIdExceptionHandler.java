...
@ControllerAdvice
public class IncompatibleIdExceptionHandler {

    @ResponseStatus(HttpStatus.BAD_REQUEST)
    @ResponseBody
    @ExceptionHandler(IncompatibleIdsException.class)
    public ResponseEntity<ExceptionHandlerDto<?>> handle(IncompatibleIdsException ex) {
